        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Building predictive models using classification, regression, and clustering techniques.
              </p>
              ...
              <div className="what-content-flex">
                ...
                <div className="what-tags">Statsmodels</div>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Transforming raw data into actionable insights using Python, SQL, and BI tools. Skilled in EDA and dashboards.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
